...
const CATEGORY_CARDS = [
  {
    ...
    items: [
      ...
      { label: 'Figurines & vases', img: 'https://images.unsplash.com/photo-1581783342308-f792dbdd27c5?w=160&q=80' },
  ...
  },
  {
    ...
    items: [
      { label: 'Dumbbells', img: 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=160&q=80' },
      ...
      { label: 'Cycles', img: 'https://images.unsplash.com/photo-1485965120184-e220f721d03e?w=160&q=80' },
    ],
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Notebooks', img: 'https://images.unsplash.com/photo-1531346878377-a5be20888e57?w=160&q=80' },
              ...
              <Link key={item.label} to={card.link} className="cat-card-item">
                <img src={item.img} alt={item.label}
                  onError={(e) => { 
                    ...
                    target.onerror = null;
                    target.src = 'https://placehold.co/160x160/f5f5f5/aaa?text=' + encodeURIComponent(item.label); 
                  }} />
